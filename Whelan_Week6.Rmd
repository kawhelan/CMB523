...
<"i" represents the row index of sequencing_matrix. "j" represents the column index of sequencing matrix.
...
<The "a" wasn't replaced in the second code - am I doing something wrong? I would guess we're only calling the functions once in this code, as opposed to several times in the first code>
...
<Does the loop execute for each row in sequencing_matrix? If so, 1000 times.>
...
<I can't tell yet because my timer only works sometimes, even though I used the same code for all>
